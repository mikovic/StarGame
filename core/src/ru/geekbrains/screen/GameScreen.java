...
public class GameScreen extends BaseScreen {
    ...
    public void action(){
        ...
        explosionPool.getActiveObjects().clear();
        this.mainShip = new MainShip(atlas, bulletPool, explosionPool, laserSound);
        mainShip.resize( getWorldBounds());
